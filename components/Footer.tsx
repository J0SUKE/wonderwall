      ...
      <div data-speed="0.5" className='pt-[10vw]'>
        <ul className='px-[5%] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[2vw]'>
            <li>
              ...
              <input type="text" placeholder='Your email address' className='border-b border-[black] w-[100%] pb-[.4rem] mt-[3rem]'/>
              <button className='py-[.5rem] px-[1.6rem] border border-[darkgray] mt-[.7rem]'>Sign up</button>
            </li>
            ...
            <li className='lg:mt-[0] mt-[2rem] hidden sm:block'>
              ...
              <ul className='flex flex-col gap-[.7rem] items-start mt-[1rem]'>
                ...
                <FooterLink link='mailto:bp@wonderwall-studio.pl' text='bp@wonderwall-studio.pl'/>
              </ul>
              ...
              <ul className='flex flex-col gap-[.7rem] items-start mt-[1rem]'>
                ...
                <FooterLink link='mailto:info@wonderwall-studio.pl' text='info@wonderwall-studio.pl'/>
              </ul>
            </li>
        ...
        <ul className='px-[5%] grid grid-cols-3 gap-[2rem] mt-[3rem]'>
          <div className='hidden sm:flex items-start gap-[1.4rem]'>
              <ExternalLink text='Facebook' link='https://www.facebook.com/WonderWallStudio'/>
              <ExternalLink text='Instagram' link='https://www.facebook.com/WonderWallStudio'/>
          </div>
          <p className='hidden sm:block text-center text-[darkgray] text-[.95rem]'>Copyright © 2016-2019 Idealab Sp. z o. o. </p>
          
          <div className='  flex flex-col items-start sm:items-end gap-[.7rem]'>
            <p className='text-[darkgray] text-[.95rem]'>
              Designed by <ExternalLink text='Obys' link='https://obys.agency/'/>
            </p>
            <p className='text-[darkgray] text-[.95rem]'>
              Code by <ExternalLink text='Jean' link='https://jeanmazouni.com/'/>
            </p>
          </div>
        </ul>
      </div>
