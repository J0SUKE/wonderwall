...
export default function InfoBlock({text,link,style,infoBlockRef}:{text:string,link:string,style?:string,infoBlockRef?:React.MutableRefObject<HTMLDivElement>}) {
  return (
