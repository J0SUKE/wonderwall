  ...
  return (
    <div className="md:flex justify-between mt-[2rem] pl-[2%] pr-[2%] md:pr-0 lg:pl-[4%] pb-[6rem]">
      <div className="relative z-[1] w-[100%] md:w-[45%] lg:w-[40%]">
        <h2 ref={title} className="text-[#202020] opacity-[.5]">
          About our wallpapers
        </h2>
        <p ref={paragraph} className="text-[.95rem] mt-[2rem] text-[#202020]">
          Our wallpapers are a world of hand painted or drawn designs. Each
          graphic contains not only carefully worked out details and impressive
          colors, but also a huge amount of artistic work and enthusiasm for
          creation. We want to bring the world of art to your interiors.
        </p>
        <ul
          ref={List}
          className="grid grid-cols-2 grid-rows-2 items-end mt-[2.5rem] gap-[2rem]"
        >
          <li>
      ...
      <div className="relative mt-[3rem] md:mt-0 h-[100vw] md:h-[auto] z-[2] w-[100%] md:w-[50%]">
        <div className="absolute w-[100%] h-[100%] overflow-hidden">
          <div
            className="relative top-0 left-0 bottom-0 right-0 w-[100%] h-[120%]"
            data-speed="auto"
          >
            <Image
              alt={""}
        ...
        <div className="absolute bottom-0 left-0 md:left-[-10%] w-[100%] md:w-[110%] h-[100%]">
          <img
            className="absolute bottom-0 object-contain max-h-[600px]"
            src="/images/wallpapper-girl@2x.png"
            alt=""
          />
        </div>
      </div>
