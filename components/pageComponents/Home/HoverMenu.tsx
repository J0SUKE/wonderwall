  ...
  return (
    <div className="w-[65%] hidden md:block">
      <ul className="relative z-[2] flex flex-col gap-[1.6rem]">
        <HoverMenuItem
          link={
            "https://wonderwall-studio.pl/kategoria-produktu/wallpapers/?lang=en"
          }
        ...
        <HoverMenuItem
          link={
            "https://wonderwall-studio.pl/kategoria-produktu/paint/?lang=en"
          }
        ...
        <HoverMenuItem
          link={
            "https://wonderwall-studio.pl/kategoria-produktu/glue-varnish/?lang=en"
          }
        ...
        <HoverMenuItem
          link={
            "https://wonderwall-studio.pl/kategoria-produktu/outlet/?lang=en"
          }
...
function HoverMenuItem({
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      itemRef.current.querySelector(".line"),
      {
        scaleX: 0,
      },
      {
  ...
  useEffect(() => {
    ...
    window.addEventListener("mousemove", (e) => {
      ...
      mouseposition.x =
        ...
        hoverImg.current.getBoundingClientRect().width;
    });
  ...
  return (
    <li>
      <a
        className="flex py-[1.3rem] items-end hoverItem relative"
        ref={itemRef}
        href={link}
        target={"_blank"}
      ...
      >
        ...
        <p className="text-[#7f7f7f] text-[.9rem] transition-[color] duration-300 pointer-events-none">
          {index}
        </p>
        <div className="relative flex justify-between items-end w-[100%] pointer-events-none">
          <h2 className="text-[2.8rem] leading-[2.5rem] capitalize ml-[2rem]">
            {value}
          </h2>
          <p className="text-[#7f7f7f] text-[.9rem] transition-opacity duration-300">
            ({number})
          </p>

          <span className="absolute right-[0] translate-x-[-100%] transition-all duration-300  opacity-0 flex items-center gap-[.3rem] pointer-events-none text-[.9rem] leading-[.9rem] more">
            More
            <span className="block rotate-90 mt-[.1rem]">
              <Image
