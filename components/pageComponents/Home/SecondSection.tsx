  ...
  return (
    <div className='relative pb-[4rem]'>
      ...
      <div className='relative z-[2]'>
        <p className='flex gap-[1rem] pt-[4.7rem] pl-[11%] text-[.9rem] text-[#202020] opacity-[.6]'>
            <span>Bułgarska 15/LU3 st.</span>
            <span>Tetmajera 83 st.</span>
        </p>
        <div className='pl-[11%] pr-[10%] mt-[2rem] flex justify-between items-end'>
          <h2 className='text-[clamp(3rem,5vw,5vmax)]'>
            <span className='leading-[clamp(3.3rem,5.4vw,5.4vmax)] block'>OUR SHOWROOMS</span>
            <span className='leading-[clamp(3.3rem,5.4vw,5.4vmax)] block noto font-[300]'>IN CRACOW</span>
          </h2>
          <div ref={SliderButtonContainer} className='flex gap-[1rem]'>
          </div>        
        </div>
