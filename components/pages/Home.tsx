        ...
        <div ref={MaroonZone}>
            ...
            <div className='mt-[3rem] sm:mt-[12rem] px-[5%]'>
              ...
              <div className='pb-[20vh] mt-[3rem] flex flex-col sm:flex-row items-start sm:items-center gap-[.7rem]'>
                  <ImageHoverLink text='About us' link='/about' image='/images/m.jpg'/>
                  <span className='hidden sm:block mt-[.6rem] h-[.2rem] w-[2rem] bg-[white]'></span>
                  <ImageHoverLink text='Wallpapers' link='/' image='/images/Bez-nazwy-3.jpg'/>
                  <span className='hidden sm:block mt-[.6rem] h-[.2rem] w-[2rem] bg-[white]'></span>
                  <ImageHoverLink text='Free samples' link='/' image='/images/pr.jpg'/>
              </div>
            </div>
        </div>
      </div>
...
function ImageHoverLink({image,link,text}:{image:string,link:string,text:string}) 
{
  ...
  useEffect(()=>{
    ...
    itemRef.current?.addEventListener('mousemove',(e)=>{
      ...
      mouseposition.y = e.offsetY+hoverImg.current.getBoundingClientRect().height/4;      
    })
  ...
  return <Link href={link} passHref>
    ...
    >
      ...
      <div className='hidden sm:block absolute bottom-0 w-[12rem] transition-[height] duration-500 h-[0] overflow-hidden pointer-events-none hover-img-b' ref={hoverImg}>
